...
<head>
    ...
    <style>
        body {
            background-image: url("image/bg7.jpg"); /* Replace with your image path */
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="manager-dashboard.php" class="bg-green-600 px-4 py-2 rounded-lg hover:bg-green-700">Dashboard</a>
